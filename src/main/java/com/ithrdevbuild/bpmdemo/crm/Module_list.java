...
public class Module_list  implements java.io.Serializable {
    private com.ithrdevbuild.bpmdemo.crm.Module_list_entry[] modules;

    public Module_list() {
    }

    public Module_list(
           com.ithrdevbuild.bpmdemo.crm.Module_list_entry[] modules) {
     ...
     * @return modules
     */
    public com.ithrdevbuild.bpmdemo.crm.Module_list_entry[] getModules() {
        return modules;
    }
     ...
     * @param modules
     */
    public void setModules(com.ithrdevbuild.bpmdemo.crm.Module_list_entry[] modules) {
        this.modules = modules;
    }
