...
public class Link_name_value  implements java.io.Serializable {
    ...
    private com.ithrdevbuild.bpmdemo.crm.Link_value2[] records;
    ...
    public Link_name_value(
           ...
           com.ithrdevbuild.bpmdemo.crm.Link_value2[] records) {
           this.name = name;
     ...
     * @return records
     */
    public com.ithrdevbuild.bpmdemo.crm.Link_value2[] getRecords() {
        return records;
    }
     ...
     * @param records
     */
    public void setRecords(com.ithrdevbuild.bpmdemo.crm.Link_value2[] records) {
        this.records = records;
    }
