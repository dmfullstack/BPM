...
public class Entry_value  implements java.io.Serializable {
    ...
    private com.ithrdevbuild.bpmdemo.crm.Name_value[] name_value_list;
    ...
    public Entry_value(
           ...
           com.ithrdevbuild.bpmdemo.crm.Name_value[] name_value_list) {
           this.id = id;
     ...
     */
    public com.ithrdevbuild.bpmdemo.crm.Name_value[] getName_value_list() {
        return name_value_list;
    }
     ...
     */
    public void setName_value_list(com.ithrdevbuild.bpmdemo.crm.Name_value[] name_value_list) {
        this.name_value_list = name_value_list;
    }
