...
public class SugarsoapLocator extends org.apache.axis.client.Service implements com.ithrdevbuild.bpmdemo.crm.Sugarsoap {
    ...
    public com.ithrdevbuild.bpmdemo.crm.SugarsoapPortType getsugarsoapPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.ithrdevbuild.bpmdemo.crm.SugarsoapPortType getsugarsoapPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.ithrdevbuild.bpmdemo.crm.SugarsoapBindingStub _stub = new com.ithrdevbuild.bpmdemo.crm.SugarsoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.ithrdevbuild.bpmdemo.crm.SugarsoapPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.ithrdevbuild.bpmdemo.crm.SugarsoapBindingStub _stub = new com.ithrdevbuild.bpmdemo.crm.SugarsoapBindingStub(new java.net.URL(sugarsoapPort_address), this);
                _stub.setPortName(getsugarsoapPortWSDDServiceName());
                return _stub;
            }
        }
