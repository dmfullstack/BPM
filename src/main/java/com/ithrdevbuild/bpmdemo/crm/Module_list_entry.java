...
public class Module_list_entry  implements java.io.Serializable {
    ...
    private com.ithrdevbuild.bpmdemo.crm.Acl_list_entry[] acls;
    ...
    public Module_list_entry(
           ...
           com.ithrdevbuild.bpmdemo.crm.Acl_list_entry[] acls) {
     ...
     * @return acls
     */
    public com.ithrdevbuild.bpmdemo.crm.Acl_list_entry[] getAcls() {
        return acls;
    }
     ...
     * @param acls
     */
    public void setAcls(com.ithrdevbuild.bpmdemo.crm.Acl_list_entry[] acls) {
        this.acls = acls;
    }
