...
public class Field  implements java.io.Serializable {
    ...
    private com.ithrdevbuild.bpmdemo.crm.Name_value[] options;
    ...
    public Field(
           ...
           int required,
           com.ithrdevbuild.bpmdemo.crm.Name_value[] options,
     ...
     * @return options
     */
    public com.ithrdevbuild.bpmdemo.crm.Name_value[] getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(com.ithrdevbuild.bpmdemo.crm.Name_value[] options) {
        this.options = options;
    }
