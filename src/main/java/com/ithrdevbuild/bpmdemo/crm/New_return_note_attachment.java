...
public class New_return_note_attachment  implements java.io.Serializable {
    private com.ithrdevbuild.bpmdemo.crm.New_note_attachment note_attachment;

    public New_return_note_attachment() {
    }

    public New_return_note_attachment(
           com.ithrdevbuild.bpmdemo.crm.New_note_attachment note_attachment) {
     ...
     */
    public com.ithrdevbuild.bpmdemo.crm.New_note_attachment getNote_attachment() {
        return note_attachment;
    }
     ...
     */
    public void setNote_attachment(com.ithrdevbuild.bpmdemo.crm.New_note_attachment note_attachment) {
        this.note_attachment = note_attachment;
    }
