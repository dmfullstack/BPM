...
public class New_return_document_revision  implements java.io.Serializable {
    private com.ithrdevbuild.bpmdemo.crm.Document_revision document_revision;

    public New_return_document_revision() {
    }

    public New_return_document_revision(
           com.ithrdevbuild.bpmdemo.crm.Document_revision document_revision) {
     ...
     */
    public com.ithrdevbuild.bpmdemo.crm.Document_revision getDocument_revision() {
        return document_revision;
    }
     ...
     */
    public void setDocument_revision(com.ithrdevbuild.bpmdemo.crm.Document_revision document_revision) {
        this.document_revision = document_revision;
    }
